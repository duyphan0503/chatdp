...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    // Note: Provide AuthBloc if not already provided upstream (which it likely is not for a new route pushed)
    // However, usually AuthBloc is global or scoped. Given LoginPage setup, it creates a new AuthBloc.
    // We should probably check if we want a global AuthBloc or per-page.
    // For now, I'll create a new one like LoginPage.
    return BlocProvider(
